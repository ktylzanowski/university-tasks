import unittest
from friendly_numbers import div_sum


class TestFriendly(unittest.TestCase):
    def test_friendly_numbers(self):
        self.assertEqual(div_sum(-100, 100), {})
        self.assertEqual(div_sum(0, 200000), {220: 284, 1184: 1210, 2620: 2924, 5020: 5564, 6232: 6368, 10744: 10856,
